...
- `294_benjadmin_weekly_development_flow_v2_1_multiweek_trend_20260819.md` – Weekly Development Flow V2.1 többhetes trend checkpoint: 8 hetes score/aktivitás/lezárt/várakozás/hiba grafikon, 24/24 contract, tsc PASS, PROD DENY.
