...
- `295_benjadmin_weekly_development_flow_v2_2_portfolio_20260819.md` – Weekly Development Flow V2.2 projektportfólió checkpoint: aktív projektek heti score/státusz/aktivitás/lezárt/várakozás/hiba összevetése, 26/26 contract, tsc PASS, PROD DENY.
