...
export default async function TeamsMeetingAssistantStagePage({ searchParams }: PageProps) {
  ...
  return <TeamsMeetingAssistantClient fallbackMeetingId={meetingId} initialRole="participant" stage accessToken={accessToken} />;
}
