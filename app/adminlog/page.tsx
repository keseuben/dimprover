      ...
      <section className="mx-auto flex w-full max-w-6xl flex-col gap-6">
        <div className="rounded-[24px] border border-cyan-400/20 bg-slate-950/80 p-5">
          ...
          <div className="mt-3 flex flex-col justify-between gap-4 lg:flex-row lg:items-end">
            ...
            <a href="/admin" className="rounded-xl border border-cyan-400/30 px-4 py-2 text-sm font-semibold text-cyan-100 hover:bg-cyan-400/10">Vissza a licencadminhoz</a>
          </div>
        </div>
