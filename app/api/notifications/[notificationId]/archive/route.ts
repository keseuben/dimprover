...
import { archiveNotification } from "@/app/lib/notifications/notificationStore";
...
export async function POST(request: NextRequest, context: RouteContext) {
  ...
  const recipient = await archiveNotification(params.notificationId, auth.userAliases, auth.userId);
  if (!recipient) {
