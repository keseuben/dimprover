...
export async function POST(request: NextRequest, context: RouteContext) {
  try {
    ...
    return NextResponse.json({ ok: true, version: "DROP 1.2.13", initialized, warning: "A feltöltési intent egyszer használható. A fájl karanténba kerül, letölteni csak vírusellenőrzés után lehet." }, { status: 201, headers: dropNoStoreHeaders() });
  } catch (error) {
