...
export async function GET(request: NextRequest) {
  try {
    ...
    if (!rawSession) {
      return NextResponse.json({ ok: true, version: "DROP 1.2.13", resume: null }, { headers: dropNoStoreHeaders() });
    }
    ...
    return NextResponse.json({ ok: true, version: "DROP 1.2.13", resume }, { headers: dropNoStoreHeaders() });
  } catch (error) {
