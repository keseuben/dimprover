...
export async function POST(request: NextRequest) {
  try {
    ...
    return NextResponse.json({ ok: true, version: "DROP 1.2.13", initialized, warning: "A fájl privát karanténba kerül. Vírusellenőrzés előtt nem tölthető le." }, { status: 201, headers: dropNoStoreHeaders() });
  } catch (error) {
