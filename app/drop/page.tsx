        ...
        <div className="relative mx-auto grid max-w-[1500px] gap-10 px-5 py-12 sm:px-8 sm:py-16 lg:grid-cols-[1.08fr_.92fr] lg:items-center lg:py-20">
          <div>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              <Link href="/terep" className="inline-flex items-center gap-2 rounded-2xl border border-cyan-300 bg-cyan-50 px-5 py-3.5 text-sm font-black text-cyan-950"><MapPinned size={18}/> Terepi Gyorsrögzítő</Link>
            </div>
