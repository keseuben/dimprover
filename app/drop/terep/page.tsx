    ...
    return (
      <main className="min-h-[100dvh] bg-[#f3f8f8] px-4 py-10 text-slate-900">
        <section className="mx-auto max-w-xl rounded-[2rem] border border-amber-200 bg-white p-6 shadow-sm">
          <p className="text-xs font-black uppercase tracking-[.15em] text-amber-700">DIMPRO Drop · Terepi Gyorsrögzítő</p>
          <h1 className="mt-2 text-2xl font-black">A Terepi Gyorsrögzítő modul jelenleg nincs aktiválva</h1>
