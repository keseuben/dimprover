export const DEV_CENTER_ENGINE_SCHEMA_VERSION = "0.2.0";
export const DEV_CENTER_ENGINE_BOOTSTRAP_ID = "BENJADMIN-B3-M2-20260810";
...
export const DEV_CENTER_ENGINE_TABLES = [
  ...
  "dev_center_work_segments", "dev_center_audit_events",
] as const;
