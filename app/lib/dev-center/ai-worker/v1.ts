...
function mapTask(row: TaskRow) {
  ...
  return {
    ...
    providerPrompt: record(metadata.providerPrompt),
    providerOutputArtifact: record(metadata.providerOutputArtifact),
    runCoordinator: record(metadata.runCoordinator),
    workspacePlan: record(metadata.workspacePlan),
    patchApplication: record(metadata.patchApplication),
    mforgeResult: record(metadata.mforgeResult),
    vguardReviewPrompt: record(metadata.vguardReviewPrompt),
    vguardReview: record(metadata.vguardReview),
    scope: row.scope,
