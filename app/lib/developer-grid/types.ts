...
export const DEVELOPER_GRID_VERSION = "0.1.65-dev" as const;
...
export type DevelopmentContext = {
  ...
  chatConversationConfirmedBy?: "EXISTING_CHAT_SELECTION" | "USER_CURRENT_CHAT" | "USER_MANUAL_REBIND" | "USER_LEGACY_SURFACE_BIND" | "CONVERSATION_ROLLOVER" | null;
