...
export function normalizeWorkStartInput(input: Record<string, unknown>) {
  ...
  if (surfaceType !== "CHATGPT") {
    const error = new Error(surfaceType === "CODEX"
      ...
      : "A Work OpenAI first-party surface v0.1.58-ra van előkészítve. Task létrehozása v0.1.58-ban tiltott.");
    Object.assign(error, { code: surfaceType === "CODEX" ? "CODEX_TASK_BRIDGE_REQUIRED" : "WORK_SURFACE_PLANNED_V0158", status: 409 });
    throw error;
  }
