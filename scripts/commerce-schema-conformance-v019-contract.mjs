...
const checks=[
 ...
 ["20 receiving repository writes canonical unit_cost",receiving.includes("unit_cost:cost(")&&receiving.includes("unitCost:nullableText(row.unit_cost)")],
 ["21 order repository writes canonical priceNet",order.includes("priceNet:money(")&&order.includes("priceNet:text(row.price_net)")],
