...
has("preview-default-six", source.preview, /DEFAULT_MAX_PREVIEWS = 6/);
has("preview-hard-twelve", source.preview, /HARD_MAX_PREVIEWS = 12/);
...
has("email-preview-summary", source.emailTemplate, /teljes méretű fájlok a biztonságos Drop-linken/);
