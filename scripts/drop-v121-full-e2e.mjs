...
const USER_AGENT = 'DIMPRO DROP 1.2.1 full UX Identity E2E';
...
async function main() {
  ...
  const evidence = { ok: false, version: 'DROP 1.2.1', checks: [], auditEvents: [], rateLimit: null, accountingCount: null, packagePublicCode: null, projectCode: null, cleanup: { s3Objects: 0 } };
  ...
  try {
    ...
    const out = '.work_drop_v120_full_e2e_result.json';
