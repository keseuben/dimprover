...
const checks = [
  ...
  ["06 quantities use NUMERIC(19,6) normalization", repo.includes("normalizeQuantity") && repo.includes("compareDecimal") && conformance.includes("physical_delta type numeric(19,6)")],
