...
check("44 Difference blend", source.visualCompare.includes('mode === "DIFFERENCE" ? "difference" : "normal"') && source.visualCompare.includes("mixBlendMode: pointAlignmentCollecting ? \"normal\" : topBlend"), "A különbségnézet CSS difference blenddel emeli ki az eltérést.");
