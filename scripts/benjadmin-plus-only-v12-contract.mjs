...
check("Plus CLI supports one-command pull", () => assert.ok(['"pull"', '"next"', '"claim"'].every((token) => files.cli.includes(token)) && files.cli.includes("plus-bridge/${encodeURIComponent(workerCode)}/next")));
