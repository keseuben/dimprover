...
check("Weekly ready state is scoped to selected project",()=>assert.ok(panel.includes("const readyForSelection = Boolean(summary?.ready && summaryProjectId === selectedProjectId)")&&panel.includes("data-ready={readyForSelection ? \"true\" : \"false\"}")));
