...
try{
 ...
 check("Alacsony bizonyosságú generikus találat nem auto-write scope",!(analysis.approvedScope||[]).some(scope=>/MeetingAiDocumentStudio|160_benjadmin_table_first_fajlmuhely_versions|161_benjadmin_table_first_hage_versions|test-meeting-preview-token/.test(scope.key)),JSON.stringify(analysis.approvedScope||[]));
