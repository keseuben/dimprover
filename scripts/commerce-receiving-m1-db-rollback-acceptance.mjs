...
declare
 ...
 v_receipt uuid:=gen_random_uuid(); v_item1 uuid:=gen_random_uuid(); v_item2 uuid:=gen_random_uuid(); v_post jsonb; v_dup jsonb;
 v_physical numeric; v_quarantine numeric; v_movements int; v_audit int; v_outbox int;
begin
