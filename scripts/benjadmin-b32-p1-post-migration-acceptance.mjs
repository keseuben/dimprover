...
try {
  ...
  check("Operator UI keeps OutminAI default-deny P2 policy", state.panelText.includes("Outmin-AI") && state.panelText.includes("DEFAULT DENY") && state.panelText.includes("P2"));
