...
try{
  ...
  pass('v120-version-visible',mobile.text.includes('DROP 1.2.0'));
  ...
  console.log(JSON.stringify({ok:true,version:'DROP 1.2.0',checks:checks.length,names:checks,desktop:true,mobile:true,projectCodeVerified:true},null,2));
} finally {
