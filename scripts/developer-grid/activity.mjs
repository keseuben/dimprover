...
const event = {
  ...
  origin,
  workerCode,
  taskId: args.taskId || "dev-task-benjadmin-developer-grid-v013-20260905",
  projectId: args.projectId || "project_dimprover",
  branch: args.branch || "feature/benjadmin-developer-grid-v013-outminai-20260905",
  worktree: args.worktree || "/srv/dimpro-dev/worktrees/benjadmin-developer-grid-v013-outminai-20260905",
  head: args.head || null,
  timestamp,
