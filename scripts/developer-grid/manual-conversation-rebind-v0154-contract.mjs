...
check("project-root or foreign drift still retains automatic restore path",()=>assert.match(main,/await view\.webContents\.loadURL\(pin\.conversationUrl\)/));
...
console.log(`Developer Grid manual conversation rebind v0.1.54 contract PASS · ${n}/${n}`);
