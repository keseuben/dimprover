...
check("Desktop ACK expectation verifies proof hash",()=>{assert.match(main,/sourceProofSha256: resolvedExecutionProofSha256\(task\)/);assert.match(main,/function resolvedExecutionProofSha256/);assert.match(ack,/mismatches\.push\("sourceProof"\)/)});
