...
check("facade publishes schemaVersion 2 and normalized nodes", () => { assert.match(facade, /schemaVersion: 2/); assert.match(facade, /nodes, overall: aggregateInfrastructureHealth\(nodes\), alerts: infrastructureHealthAlerts\(nodes\), servers, storage/); });
