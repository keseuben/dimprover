...
check("surface adapter separates embedded ChatGPT from native Codex", () => { assert.match(adapter,/class ChatGptSurfaceAdapter/); assert.match(adapter,/class CodexSurfaceAdapter/); assert.match(adapter,/CODEX_NATIVE_BRIDGE_REQUIRED/); });
