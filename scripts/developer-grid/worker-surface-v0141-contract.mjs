...
check("desktop version v0.1.59", () => assert.equal(pkg.version, "0.1.59"));
...
check("Work adapter remains fail-closed for v0.1.59", () => assert.match(adapter,/WORK_SURFACE_PLANNED_V0159/));
