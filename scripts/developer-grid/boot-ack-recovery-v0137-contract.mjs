...
check("current package keeps v0.1.37 recovery", () => assert.equal(pkg.version, "0.1.67"));
check("current backend keeps v0.1.37 recovery", () => assert.match(types, /DEVELOPER_GRID_VERSION = "0.1.67-dev"/));
