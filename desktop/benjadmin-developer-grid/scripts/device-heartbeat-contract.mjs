...
check("portable artifact hash has stable byte-identical fallback",()=>{assert.match(main,/for \(const file of desktopArtifactCandidates\(\)\)/);assert.match(main,/try the next byte-identical physical artifact candidate/);});
