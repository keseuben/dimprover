...
contextBridge.exposeInMainWorld("chatGrid", {
  ...
  copyDeveloperGridTaskBridgeToCodex: (taskId = "") => ipcRenderer.invoke("task-bridge:copy-bootstrap", { taskId }),
  copyDeveloperGridTaskBridgeReviewToBenAi: (taskId = "") => ipcRenderer.invoke("task-bridge:copy-review", { taskId }),
  resumeDeveloperGridTaskBridgeRework: (taskId = "") => ipcRenderer.invoke("task-bridge:resume-rework", { taskId }),
  importDeveloperGridTaskBridgeReview: (taskId = "") => ipcRenderer.invoke("task-bridge:import-review", { taskId }),
  requestDeveloperGridTaskBridgeBuild: (taskId = "") => ipcRenderer.invoke("task-bridge:request-build", { taskId }),
  importDeveloperGridTaskBridgeAcceptance: (taskId = "") => ipcRenderer.invoke("task-bridge:import-acceptance", { taskId }),
  heartbeatDeveloperGridTaskBridge: (taskId = "") => ipcRenderer.invoke("task-bridge:heartbeat", { taskId }),
  importDeveloperGridTaskBridgeResult: (taskId = "") => ipcRenderer.invoke("task-bridge:import-result", { taskId }),
  ...
  prepareConversationRollover: (workerCode) => ipcRenderer.invoke("conversation-rollover:prepare", { workerCode }),
  copyConversationRollover: (workerCode) => ipcRenderer.invoke("conversation-rollover:copy", { workerCode }),
  downloadConversationRolloverHandoff: (workerCode) => ipcRenderer.invoke("conversation-rollover:download", { workerCode }),
  ...
  onTaskBridgeState: (callback) => ipcRenderer.on("task-bridge:state", (_event, payload) => callback(payload)),
