...
(() => {
  ...
  function workStartView() {
    ...
    const launchOptions=isCodex
      ...
      : isWork
        ? `<fieldset class="cw-chat-mode"><legend>ChatGPT Work</legend><label class="is-selected"><span><strong>OPENAI FIRST-PARTY · WORK</strong><small>A Work adapter v0.1.43-ban aktiválódik. Ebben a verzióban taskindítás még tiltott.</small></span></label></fieldset>`
  ...
  async function startWork(){
    ...
    const surfaceType=selectedWorkerSurface();
    if(surfaceType==="WORK"){state.workStartStatus="BLOKKOLT";state.workStartNotice="A Work surface OpenAI first-party, de a Work adapter v0.1.43-ban aktiválódik. Task nem jött létre.";state.workStartNoticeTone="warning";render();return;}
