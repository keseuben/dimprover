...
(() => {
  ...
  function workStartView() {
    ...
    const launchOptions=isCodex
      ...
      : isWork
        ? `<fieldset class="cw-chat-mode"><legend>ChatGPT Work</legend><label class="is-selected"><span><strong>OPENAI FIRST-PARTY · WORK</strong><small>A Work adapter v0.1.63-ban aktiválódik. A v0.1.61 patchben taskindítás továbbra is tiltott.</small></span></label></fieldset>`
