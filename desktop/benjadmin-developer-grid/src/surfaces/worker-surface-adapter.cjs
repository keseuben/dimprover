...
class WorkSurfaceAdapter extends WorkerSurfaceAdapter {
  ...
  automationBlock() {
    return {
      ...
      error: "A Work surface adapter v0.1.67-ben aktiválódik. A v0.1.61 startup-restore/readability patchben a modell/provenance továbbra is előkészített, de a választás fail-closed.",
    };
  }
}
