...
class WorkSurfaceAdapter extends WorkerSurfaceAdapter {
  ...
  automationBlock() {
    return {
      ok: false,
      code: "WORK_SURFACE_PLANNED_V0147",
      error: "A Work surface adapter v0.1.47-ban aktiválódik. v0.1.46-ban a live BOOT ACK monitor/recovery hotfix miatt a modell/provenance továbbra is előkészített, de a választás fail-closed.",
    };
  }
}
