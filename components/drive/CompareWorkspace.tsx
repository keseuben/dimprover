              ...
              return (
                <article className={styles.compareDocumentCard} key={side}>
                  ...
                  <div className={styles.comparePreviewPlaceholder}>
                    <FileSearch2 size={24} />
                    <div><strong>DocumentViewer csatlakozási pont</strong><span>A vizuális PDF/kép oldalnézet és overlay erre a Compare panelre kerül a következő Viewer-szeletben.</span></div>
                  </div>
