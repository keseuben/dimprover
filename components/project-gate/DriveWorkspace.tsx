        ...
        <div className={styles.documentPanel}>
          ...
          {browserViewMode === "review" && <section className={styles.reviewHost}>
            ...
            <div className={styles.reviewFilters}>
              ...
              <button type="button" className={styles.reviewReset} disabled={reviewDiscipline === "all" && reviewTopic === "all" && reviewStatus === "all"} onClick={() => { setReviewDiscipline("all"); setReviewTopic("all"); setReviewStatus("all"); }}>Szűrők törlése</button>
            </div>
