...
import { CommerceReceivingMediaAttachments } from "./CommerceReceivingMediaAttachments";
...
type ReceiptItem={id:string;receiptId:string;variantId:string;stockStatus:string;quantity:string;unit:string;unitCost:string|null;currency:string;lotCode:string|null;expiryDate:string|null;notes:string|null};
...
type NewItem={productId:string;variantId:string;quantity:string;stockStatus:"SELLABLE"|"QUARANTINE"|"DAMAGED"|"OUTLET";unit:string;unitCost:string;lotCode:string;expiryDate:string};
const EMPTY_RECEIPT:NewReceipt={receiptNumber:"",supplierName:"",supplierDocumentNumber:"",warehouseId:"",sourceId:"",notes:""};
const EMPTY_ITEM:NewItem={productId:"",variantId:"",quantity:"1",stockStatus:"SELLABLE",unit:"DB",unitCost:"",lotCode:"",expiryDate:""};
