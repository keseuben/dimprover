...
import { AlertCircle, Barcode, Boxes, ChevronRight, Layers3, Loader2, Package, PackagePlus, Pencil, Plus, RefreshCw, Search, ShoppingCart, SlidersHorizontal, Store, Tags, X } from "lucide-react";
      ...
      <div className="min-h-screen">
        <header className="border-b border-slate-200 bg-white px-4 py-4 sm:px-6">
          <div className="mx-auto flex max-w-[1600px] flex-wrap items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2"><Link href="/aruter/admin/storefront" className="hidden h-11 items-center gap-2 rounded-xl border border-teal-200 bg-teal-50 px-4 font-black text-teal-700 xl:inline-flex"><Store size={17} /> Storefront</Link><Link href="/aruter/admin/penztar" className="hidden h-11 items-center gap-2 rounded-xl border border-slate-200 bg-white px-4 font-black text-slate-700 lg:inline-flex"><ShoppingCart size={17} /> Pénztár</Link><Link href="/aruter/admin/bevetelezes" className="hidden h-11 items-center gap-2 rounded-xl border border-slate-200 bg-white px-4 font-black text-slate-700 sm:inline-flex"><PackagePlus size={17} /> Bevételezés</Link><Link href="/aruter/admin/torzsadatok" className="inline-flex h-11 items-center gap-2 rounded-xl border border-slate-200 bg-white px-4 font-black text-slate-700"><Tags size={17} /> Törzsadatok</Link><button
              type="button"
